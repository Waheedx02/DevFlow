...
export type SnippetWhereInput = {
  ...
  authorId?: Prisma.StringFilter<"Snippet"> | string
...
export type SnippetScalarWhereWithAggregatesInput = {
  ...
  authorId?: Prisma.StringWithAggregatesFilter<"Snippet"> | string
...
export type SnippetOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "title" | "description" | "language" | "code" | "authorId" | "createdAt" | "updatedAt", ExtArgs["result"]["snippet"]>
...
export interface SnippetFieldRefs {
  ...
  readonly authorId: Prisma.FieldRef<"Snippet", 'String'>
